...
function FeaturedDeepDiveCard({card}: {card: ArticleCard}) {
    return (
...
function DeepDiveCard({card}: {card: ArticleCard}) {
    return (
        ...
        <div className="flex flex-row mt-25 w-full">
            ...
            <div className="flex flex-col min-w-0 w-full text-right">
                ...
                <div className="mr-10 mt-5 font-bold">
                    <p>
                        short blurb about what deep dives is about
                    </p>
